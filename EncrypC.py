...
class EncryptionTool:
    ...
    def encrypt(self):
        ...
        cipher_object = AES.new(self.hashed_key_salt['key'],
                                AES.MODE_CFB,
...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        self.key_entry_label2 = tk.Label(root,
                text='Re-enter Key (Validation)', bg='#eeeeee',
                anchor=tk.W)
    ...
    def encrypt_execute(self):
        ...
        try:
            self._cipher = EncryptionTool(self._file_url.get(),
                    self._secret_key.get(), self._salt.get())
